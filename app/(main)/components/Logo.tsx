        ...
        <>
          <div className="flex items-center gap-0.5 z-10">
            ...
            <div className="relative flex items-end">
              <span className="text-black text-[1.5rem] lg:text-[2rem] font-black z-20">
                A
              </span>
              {/* Decorative A swoosh */}
          ...
          <div className="bg-white px-2 py-0.5 rounded-full shadow-sm text-red-600 font-bold text-[10px] uppercase tracking-[0.2em] -mt-2 z-20">
            Panjabi Shop
          </div>
        </>
      )}
