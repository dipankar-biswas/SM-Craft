...
export const Logo = () => {
  return (
    <Link
      href="/"
      className="relative flex flex-col items-center justify-center min-w-[150px] min-h-[50px] -mt-2"
    >
      <div className="flex items-center gap-0.5 z-10">
        <span className="text-black text-[2rem] font-black tracking-tighter">
          SMCR
        </span>
        <div className="relative flex items-end">
          <span className="text-black text-[2rem] font-black z-20">A</span>
          {/* Decorative A swoosh */}
